...
DROP TABLE IF EXISTS `points_aria_800k`;
CREATE TABLE `points_aria_800k` (
  `point` point NOT NULL,
  SPATIAL INDEX(`point`)
...
DROP TABLE IF EXISTS `points_aria_3kk`;
CREATE TABLE `points_aria_3kk` (
  `point` point NOT NULL,
  SPATIAL INDEX(`point`)
) ENGINE=Aria DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `points_aria_10kk`;
CREATE TABLE `points_aria_10kk` (
  `point` point NOT NULL,
  SPATIAL INDEX(`point`)
) ENGINE=Aria DEFAULT CHARSET=utf8;